return {
    ...
    pauseMapText = 'Sunset Valley Roleplay', -- Text shown above the map when ESC is pressed. If left empty 'FiveM' will appear

    characters = {
        imageURL = 'https://cfx-nui-mri_Qbox/web-side/icones/logo.png',
        iconAnimation = 'fade',
