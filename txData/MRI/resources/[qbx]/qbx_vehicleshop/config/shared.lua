...
--- Helicopters
    ...
    shops = {
        pdm = {
            ...
            showroomVehicles = {
                [1] = {coords = vec4(-45.65, -1093.66, 25.44, 69.5), vehicle = 'stanier'},
                [2] = {coords = vec4(-39.6, -1096.01, 25.44, 66.5), vehicle = 'dominator'},
                [3] = {coords = vec4(-48.27, -1101.86, 25.44, 294.5), vehicle = 'panto'},
                [4] = {coords = vec4(-51.21, -1096.77, 25.44, 254.5), vehicle = 'panto'},
                [5] = {coords = vec4(-40.18, -1104.13, 25.44, 338.5), vehicle = 'panto'},
                [6] = {coords = vec4(-50.66, -1093.05, 25.44, 222.5), vehicle = 'faggio'},
                [7] = {coords = vec4(-44.28, -1102.47, 25.44, 298.5), vehicle = 'faggio'}
            },
        },
