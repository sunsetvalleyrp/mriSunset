...
export const MockLocales = {
  ...
  please_enter_valid_numeric_player_id: "Please enter a valid numeric player ID",
  ...
  enter_server_id_instruction: "Enter the server ID of the player you want to add (player must be online)",
  all: "All",
  ...
  create_savings_business_account: "Create a savings or business account to get started",
  ...
  failed_add_user_invalid_response: "Failed to add user to account - Invalid response",
  adding: "Adding...",
  ...
  player_not_found_offline: "Player not found or is offline. Only online players can be added to accounts.",
  ...
  request_timed_out: "Request timed out. The player may be offline or unreachable.",
  account_suffix: "Account"
};

export const MockMoneyTypes = [
  { name: "bank", amount: 1540000 },
