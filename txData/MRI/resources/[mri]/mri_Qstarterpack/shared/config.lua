...
Config.Locations = {
    ["1"] = {                                                                       -- Unique identifier for the location
        ...
        starter_vehicle  = {         -- Vehicle settings for players receiving a starter vehicle
            ...
            model = 'panto',         -- Vehicle model (from FiveM vehicle model list) will be ignored if random_vehicle is set to true
            random_vehicle = false,   -- Spawn a random vehicle from the list (true/false)
