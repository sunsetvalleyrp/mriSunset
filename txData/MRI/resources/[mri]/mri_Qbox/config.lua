...
cfg.vipmenu = {
    ...
    Roles = {
        ...
        Sunset = {
            label = "Socio Sunset",
            payment = 1000, -- $1000 / HORA
            inventory = 200 , -- 200 KG
        },
        Sunrise = {
            label = "Socio Sunrise",
            payment = 1500, -- $1500 / HORA
            inventory = 200 , -- 200 KG
        }
    }
}
...
cfg.disableblindfiring = {
    toggle = true,                         -- true para desativar o tiro cego quando estiver pegando cover em paredes
}
...
cfg.realisticrecoil = {
    ...
    drunkAimingPower = 0.30,                -- Higher number = Higher screen shake
...
cfg.carexplosion = {
    toggle = true,                         -- true para ativar a Explosão de veículos ao cair de uma certa altura
    height = 30,                            -- qual altura você quer para ativar a explosão
}
