return {
	...
	["agua"] = {
		...
		stack = true,
		close = true,
		description = "Apenas uma garrafa de água mineral",
		client = {
			image = "agua.png",
		}[ox]/ox_inventory/web/images/sprunk.png
	},
	["cola"] = {
	...
	["sprunk"] = {
		label = "Latinha de Refrigerante de limão",
		weight = 350,
		stack = true,
		close = true,
		decay = true,
		degrade = 120,
		description = "Apenas uma latinha de refrigerante de limão",
		client = {
			status = { thirst = 200000 },
			anim = { dict = "mp_player_intdrink", clip = "loop_bottle" },
